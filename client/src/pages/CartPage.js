...
const CartPage = () => {
  ...
  return (
    <Layout title={'Your Cart - Gadget Galaxy'}>
                ...
                <div className="col-md-7">
                    {cart?.map((p) => (
                        <div className="row card mb-2 p-2 flex-row">
                            ...
                            alt={p.name} height={"150px"} width={"100px"} />
                            </div>
                ...
                <div className="col-md-4 cart-summary text-center">
                    ...
                    {auth?.user?.address?(
                        ...
                        <div className="mb-3">
                            {
                                auth?.token?(
                                    <button className='btn btn-warning' onClick={() => navigate('/dashboard/user/profile')}></button>
                                ) : (
                                    <button className='btn btn-warning' 
